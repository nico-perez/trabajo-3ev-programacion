...
public class Color {
    ...
    public static final Color ROJO = new Color(205, 92, 92), ROSA = new Color(255, 192, 203),
            NARANJA = new Color(255, 160, 122), AMARILLO = new Color(240, 230, 140), LILA = new Color(230, 230, 250),
            VERDE = new Color(152, 251, 152), AZUL = new Color(175, 238, 238), MARRON = new Color(222, 184, 135),
            BLANCO = new Color(255, 245, 238), GRIS = new Color(192, 192, 192), NEGRO = new Color(0, 0, 0),
    ...
    public static Color mezclar(Color encima, Color debajo) {
        ...
        if (enc_01_a < .001f)
            ...
            if (res_01_a < .001f)
                ...
                return new Color(
                        (int) (((enc_01_r * enc_01_a + deb_01_r * deb_01_a * (1 - enc_01_a)) / res_01_a) * 255),
    ...
    public String toString() {
        return "" + Byte.toUnsignedInt(r) + ", " + Byte.toUnsignedInt(g) + ", " + Byte.toUnsignedInt(b) + ", "
